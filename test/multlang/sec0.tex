...
\indexLita{introduzione}
\indexLeng{introduction}
...
\index{$alpha$@$\alpha$}
\index{$gamma$@$\gamma$}
\indexLeng{text for $\alpha$}
\indexLita{testo per $\alpha$}
\indexLeng{unicode for  $𝛼$}
\indexLita{unicode per  $𝛼$}
...
\begin{privateremark}
  ...
  \indexLita{commento privato}
  \indexLeng{private remark}
\end{privateremark}
