...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='DColDoc',
            fields=[
                ('nickname', models.SlugField(help_text="short string to identify this ColDoc in URLs (alphanumeric only, use '_' or '-' for other chars)", max_length=10, primary_key=True, serialize=False, validators=[ColDocDjango.ColDocApp.models.validate_coldoc_nickname], verbose_name='short string to identify')),
                ...
                ('root_uuid', ColDocDjango.ColDocApp.models.UUID_Field(default=1)),
